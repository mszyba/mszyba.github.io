import { Avatar, Icon, Input, ListItemStandard, ShellBar, ShellBarItem } from "@ui5/webcomponents-react";


export default function MenuShellBar() {
  ...
  return (
    <ShellBar
      ...
      menuItems={<>
        ...
        <ListItemStandard data-key="2">Menu Item
        2</ListItemStandard>
      ...
      profile={<Avatar><img
        src="https://sap.github.io/ui5-webcomponents-react/v2/assets/Person-B7wHqdJw.png"/></Avatar>}
